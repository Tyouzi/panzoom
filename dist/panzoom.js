  ...
  function createPanZoom(domElement, options) {
    ...
    function handleTouchMove(e) {
      if (e.touches.length === 1) {
        ...
        var centerPointX = (firstTouchPoint.x + secondTouchPoint.x) / 2;
        var centerPointY = (firstTouchPoint.y + secondTouchPoint.y) / 2;
        //新增双指滑动
        var dx = centerPointX - doubleTouchX;
        var dy = centerPointY - doubleTouchY;
        mouseX  = centerPointX;
        mouseY  = centerPointY;
        doubleTouchX = centerPointX;
        doubleTouchY = centerPointY;
        if (transformOrigin) {
          var offset = getTransformOriginOffset();
          mouseX = offset.x;
          mouseY = offset.y;
        }
       if(dx !== centerPointX && dy !== centerPointY){
        internalMoveBy(dx, dy);
       }
